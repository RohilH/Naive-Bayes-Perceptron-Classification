...
if __name__ == '__main__':
    ...
    #
    # NB.printPic(x_test, y_test)
    # Plot confusion matrix.
    # print("Total Time: ", end_test_time - start_time)
    # print("Train Time: ", end_train_time - train_time)
    # print("Test Time: ", end_test_time - test_time)
    ...
    perceptron.printPic(x_test,y_test)
    # Plot confusion matrix.
    plot_confusion_matrix(y_test, y_pred, classes=class_names, normalize=True,
                      title='Confusion matrix, with normalization')
    plt.show()
